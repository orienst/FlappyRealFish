...
struct  NativeAdType_t1094124130 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(NativeAdType_t1094124130, ___value___1)); }
