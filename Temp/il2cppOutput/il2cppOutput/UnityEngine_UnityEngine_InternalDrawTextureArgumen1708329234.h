...
{
	Rect_t3681755626_marshaled_pinvoke ___screenRect_0;
	Texture_t2243626319 * ___texture_1;
	Rect_t3681755626_marshaled_pinvoke ___sourceRect_2;
	int32_t ___leftBorder_3;
	int32_t ___rightBorder_4;
	int32_t ___topBorder_5;
	int32_t ___bottomBorder_6;
	Color32_t874517518_marshaled_pinvoke ___color_7;
	Material_t193706927 * ___mat_8;
};
// Native definition for marshalling of: UnityEngine.InternalDrawTextureArguments
struct InternalDrawTextureArguments_t1708329234_marshaled_com
{
	Rect_t3681755626_marshaled_com ___screenRect_0;
	Texture_t2243626319 * ___texture_1;
	Rect_t3681755626_marshaled_com ___sourceRect_2;
	int32_t ___leftBorder_3;
	int32_t ___rightBorder_4;
	int32_t ___topBorder_5;
	int32_t ___bottomBorder_6;
	Color32_t874517518_marshaled_com ___color_7;
	Material_t193706927 * ___mat_8;
};
